...
### FIQ debugger, ttyFIQ0 设备作为 console
...
#### DTS 使能 fiq_debugger 节点，禁止对应 uart 节点
...
#### 安卓 parameter.txt 配置 console 设备
...
#### 去掉或禁止 3.1 或 3.2 的所有配置

#### 去掉 8250 驱动 console 的配置
...
#### 安卓去掉 recovery 对 console 的使用，否则恢复出厂设置的时候会卡住
