...
This SDK is based on Buildroot 2018.02-rc3, Yocto 3.2, Debian 10 with kernel 4.19 and U-boot v2017.09. It is suitable for RK3288 EVB development boards and all other Linux products developed based on it.
...
Take RK3288_LINUX_SDK_V1.0_20210520.tgz as an example. After getting an initialization package, you can get the source code by the following command:

```shell
mkdir rk3288
tar xvf RK3288_LINUX_SDK_V1.0_20210520.tgz -C rk3288
cd rk3288
...
| ----------------------------- | --------------------------------------------------- |
| BoardConfig-rk3288-evb-rk808-k4.19.mk | Suitable for RK3288 EVB with RK808 development board |
| BoardConfig-rk3288-firefly-k4.19.mk | Suitable forRK3288 Firefly development boards |
| BoardConfig_rk3288-evb-act8846-k4.19.mk | Suitable for RK3288 EVB with ACT8846 development board |
