...
文档主要介绍 Rockchip RK3326 Linux SDK发布说明，旨在帮助工程师更快上手 RK3326 Linux SDK 开发及相关调试方法。
...
| 2021-05-20 | V1.5.0 | Caesar Wang |  开发指南章节增加软件和硬件开发一些说明文档。 <br/>增加IO电源设计注意事项。 |
...
本 SDK 支持三个系统分别基于 Buildroot 2018.02-rc3，Yocto 3.2 和 Debian 10 上开发，内核基于 Kernel 4.4，引导基于 U-boot v2017.09，适用于 RK3326 EVB 开发板及基于此开发板进行二次开发的所有 Linux 产品。
...
以 RK3326_LINUX_SDK_V1.5_20210520.tgz 为例，拷贝到该初始化包后，通过如下命令可检出源码：
...
# 例如:打印的版本号为v1.5.0，更新时间为20210520
...
| 板级配置                       | 说明                                               |
| ----------------------------- | --------------------------------------------------- |
| BoardConfig-rk3326-evb-lp3-v10.mk |  适用于 RK3326 EVB V10 开发板  |
| BoardConfig-rk3326-evb-lp3-v10-32bit.mk |  适用于 RK3326 EVB V10 开发板，运行32位系统 |
| BoardConfig-rk3326-robot64.mk |  适用于 RK3326 Robot小系统开发  |
| BoardConfig-rk3326-robot64_no_gpu.mk |  适用于 RK3326 Robot小系统不带GPU开发  |
...
若需要编译单个模块或者第三方应用，需对交叉编译环境进行配置。交叉编译工具位于 buildroot/output/rockchip_rk3326_64/host/usr 目录下，需要将工具的bin/目录和 aarch64-buildroot-linux-gnu/bin/ 目录设为环境变量，在顶层目录执行自动配置环境变量的脚本（只对当前控制台有效）：
