# Rockchip PX30 Linux SDK Release Note
...
The document presents Rockchip PX30 Linux4.19 SDK release notes, aiming to help engineers get started with  PX30 Linux SDK development and debugging faster.
...
This SDK is based on Buildroot 2018.02-rc3, Yocto 3.2, and Debian 10 or later version with kernel 4.19 and U-boot v2017.09. It is suitable for PX30 EVB development boards and all other Linux products developed based on it. This SDK supports VPU hardware decoding, GPU 3D, Wayland/X11 display, Qt and other function. For detailed functions debugging and interface introductions, please refer to the documents under the project's docs/ directory.
...
Take PX30_LINUX4.19_SDK_V1.0_20210520.tgz as an example. After geting a initialization package, you can get source code by running the following command:

```shell
mkdir px30
tar xvf PX30_LINUX4.19_SDK_V1.0_20210520.tgz -C px30
cd px30
...
# e.g.:printf version v1.0.0，update time is 20210520
# <SDK>/.repo/manifests/px30_linux4.19_release_v1.0.0_20210520.xml
```

Or refer to the project directory:

```shell
<SDK>/docs/PX30/PX30_Linux4.19_SDK_Note.md
```
...
PX30 EVB hardware design guide:

```
<SDK>/docs/PX30/Rockchip_PX30_Hardware_Design_Guide_V1.3_EN_20191206.pdf
```

PX30 EVB hardware development guide:

```
<SDK>/docs/PX30/Rockchip_PX30_User_Manual_EVB_V1.1_EN.pdf
```
...
Please refer to the following documents for details:
 ...
 ```
<SDK>/docs/PX30/Rockchip_PX30_Introduction_IO_Power_Domains_Configuration.pdf
...
| ----------------------------- | --------------------------------------------------- |
| BoardConfig-px30-evb-ddr3-v10-k4.19.mk | Suitable for PX30 EVB V10 development board  |
| BoardConfig-px30-evb-ddr3-v11-k4.19.mk  | Suitable for PX30 EVB V11 development board |
...
```shell
./build.sh device/rockchip/px30/BoardConfig-px30-evb-ddr3-v10-k4.19.mk
```

Select the board configuration of the **PX30 EVB V11 development board**:

```shell
./build.sh device/rockchip/px30/BoardConfig-px30-evb-ddr3-v11-k4.19.mk
```
...
2. BoardConfig-px30-evb-ddr3-v10-k4.19.mk
3. BoardConfig-px30-evb-ddr3-v10.mk
4. BoardConfig-px30-evb-ddr3-v11-32bit.mk
5. BoardConfig-px30-evb-ddr3-v11-k4.19.mk
6. BoardConfig-px30-evb-ddr3-v11.mk
7. BoardConfig-px30-robot64.mk
8. BoardConfig-px30-robot64_no_gpu.mk
9. BoardConfig.mk
...
If you need to build a single module or a third-party application, you need to setup the cross compilation environment. Cross compilation tool is located in “buildroot/output/rockchip_px30_64_4.19/host/usr” directory. You need to set bin/ directory of tools and aarch64-buildroot-linux-gnu/bin/ directory to environment variables, and execute auto-configuration environment variable script in the top-level directory (only valid for current console):
...
```shell
cd buildroot/output/rockchip_px30_64_4.19/host/usr/bin
...
or
SDK$rm -rf /buildroot/output/rockchip_px30_64_4.19/build/qlayer-1.0
```
...
## Upgrade Introduciton
 ...
 Interfaces layout of PX30 EVB are showed as follows:
