...
This SDK is based on Buildroot 2018.02-rc3, Yocto 3.2, and Debian 10 or later version with kernel 4.4 and U-boot v2017.09. It is suitable for PX30 EVB development boards and all other Linux products developed based on it. This SDK supports VPU hardware decoding, GPU 3D, Wayland/X11 display, Qt and other function. For detailed functions debugging and interface introductions, please refer to the documents under the project's docs/ directory.
...
Take PX30_LINUX_SDK_V1.5_20210520.tgz as an example. After geting a initialization package, you can get source code by running the following command:

```shell
mkdir px30
tar xvf PX30_LINUX_SDK_V1.5_20210520.tgz -C px30
cd px30
...
# <SDK>/.repo/manifests/px30_linux_release_v1.5.0_20210520.xml
```

Or refer to the project directory:

```shell
<SDK>/docs/PX30/PX30_Linux_SDK_Note.md
```
