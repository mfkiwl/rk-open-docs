# Rockchip RK625 RT-Thread SDK 发布说明
...
文档主要介绍 Rockchip RK625 RT-Thread SDK发布说明，旨在帮助工程师更快上手RK625 RT-Thread SDK开发及相关调试方法。
...
| **版本** | **日期** | **作者** | **修改说明** |
| -----------| :-------------- | :------------- | :---------- |
| V0.1.0 | 2021-03-12 | Hans Yang | 初始BETA V0.1.0版本 |
...
本SDK是基于RT-Thread v3.1.3 的软件开发包，包含RT-Thread系统开发用到的系统源码、驱动、工具、应用软件包。本SDK还包含开发文档，工具使用文档。适配RK625芯片平台，适用于RK625 EVB开发板及基于RK625平台开发的所有产品。
...
获取RK625 RT-Thread软件包，需要有一个帐户访问Rockchip提供的源代码仓库。客户向瑞芯微技术窗口( 邮箱地址fae@rock-chips.com)申请SDK，同步提供SSH公钥进行服务器认证授权，获得授权后即可同步代码。关于瑞芯微代码服务器SSH公钥授权，请参考第6节 [SSH公钥操作说明](# SSH 公钥操作说明)。
...
以RK625_RT-Thread_SDK_Beta_V0.1.0_20210312.tar.gz为例，获取到该初始压缩包后，通过如下命令可检出源码：
...
或通过 RKDocs/RK625_RT-Thread_Release_Note.txt 查看当前 SDK 的版本。
...
RK625 RT-Thread SDK更详细编译、调试以及刷机说明，请参考文档：
